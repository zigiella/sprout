...
| 14 | 2:30-2:50 | veo3+screen | **CIERRE (e) — Meristem diferido como tesis.** Zoom-out desde parcela B a red de 8. Cartelas secuenciales silenciosas: **"FAO: 84% explotaciones <2 ha. Producen 36% del alimento."** → **"IRRIFRAME: 40k explotaciones. Servidor central."** → **"Sprout: criterio que se mueve, se suma y se ajusta."** | 20 s | — | Veo3 + diseno cartelas. |
...
- **v0.3** (2026-04-20, Corola) — ajuste cartela cierre pedido por Bea: **"Sprout: criterio que viaja con quien se mueve."** → **"Sprout: criterio que se mueve, se suma y se ajusta."** Tres verbos reflexivos mapeando las tres capas del sistema (Pollen se mueve / Meristem se suma / Rhizome y climax se ajustan), reforzando la tripleta de la frase espinal ("Un modelo. Tres profundidades. Tres tiempos."). Sujeto unico: el criterio. Sin portador en la frase — mas agnostica aun que v0.2. Cambio puntual: solo cartela plano 14, resto sin tocar.
