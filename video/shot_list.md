# Shot list — Sprout v1.4 (apilado completo: escenas 1-9)
...
- **Variante de traducción pendiente voto Bea:** la primera línea de la invariante puede ser *"Physical layer commands."* (apilada actualmente) o *"Physical layer prevails."* (variante propuesta por Corola día 15, "prevails" más claro semánticamente). Swap textual de una palabra si Bea prefiere variante.
