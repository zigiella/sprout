...
| `RE02_explain_last_block` | `explain_local_decision` | `receipt_blocked_overlay`, `tank_recovery_plan` | `migrar_v2` | Incluir causa fisica ESP32 (`TANK_LOW`, `JETSON_HEARTBEAT_LOST`, etc.). |
