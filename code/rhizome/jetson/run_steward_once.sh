...
ACCEPT_ESP32_TEST_ONLY_PULSE_AS_EXECUTED="${ACCEPT_ESP32_TEST_ONLY_PULSE_AS_EXECUTED:-0}"
...
if [ "$ACCEPT_ESP32_TEST_ONLY_PULSE_AS_EXECUTED" = "1" ]; then
  ARGS+=(--accept-esp32-test-only-pulse-as-executed)
fi
